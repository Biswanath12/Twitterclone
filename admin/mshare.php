...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="row">
		...
		<div class="col-md-10">
        <h1 style="text-align:center;font-size:35px";>SHOW ALL SHARES </h1> 
			<table class="table-bordered" width="900px" style="text-align:center">
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<td><?php echo $row['retweet_msg']; ?></td>
						<td><?php echo $row['tweet_id']; ?></td>
						<td>
							<button class="btn" name=""><a href="dshare.php?post_id=<?php echo $row['post_id']; ?>">Delete</a></button>
						</td>
						</tr>
						<?php
					}
