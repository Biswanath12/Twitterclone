...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="row">
		...
		<div class="col-md-10">
        <h1 style="text-align:center;font-size:35px";>SHOW ALL TRENDS </h1> 
			<table class="table-bordered" width="900px" style="text-align:center">
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<td>
							<button class="btn" name=""><a href="dtrend.php?id=<?php echo $row['id']; ?>">Delete</a></button>
						</td>
						</tr>
						<?php
					}
